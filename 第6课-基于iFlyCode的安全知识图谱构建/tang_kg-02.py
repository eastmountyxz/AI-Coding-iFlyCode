...
def visualize_graph(graph: nx.DiGraph()):
    ...
    # 确保使用支持中文的字体（优先查找系统已安装的SimHei）
    zh_font = fm.FontProperties(fname='/System/Library/Fonts/STHeiti Medium.ttc') # MacOS
    # Windows用户可以使用 'C:\\Windows\\Fonts\\simhei.ttf'
    # Linux用户可以使用 '/usr/share/fonts/truetype/arphic/uming.ttc'
    
    rcParams['font.family'] = ['SimHei']  # 设置默认字体为黑体
    rcParams['axes.unicode_minus'] = False  # 解决负号显示异常的问题
    ...
    nx.draw_networkx_edge_labels(graph, pos, edge_labels=edge_labels, font_family='SimHei')
